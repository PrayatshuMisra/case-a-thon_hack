...
const PillNav: React.FC<PillNavProps> = ({
  ...
  return (
    <div className={`w-full ${className}`} data-theme={theme}>
      <nav className="w-full md:w-max flex items-center justify-between md:justify-start box-border" aria-label="Primary" style={cssVars}>
        <a
          href={items?.[0]?.href || '#'}
          aria-label="Home"
